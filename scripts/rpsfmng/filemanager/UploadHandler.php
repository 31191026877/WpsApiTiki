...
class UploadHandler
{
    ...
    protected function upcount_name($name) {
        return slug_name(preg_replace_callback(
			'/(?:(?: \(([\d]+)\))?(\.[^.]+))?$/',
    ...
    protected function get_file_name($file_path, $name, $size, $type, $error, $index, $content_range) {
        ...
        return $this->get_unique_filename($file_path,
            $this->fix_file_extension($file_path, $name, $size, $type, $error, $index, $content_range), $size, $type, $error, $index, $content_range);
    }
