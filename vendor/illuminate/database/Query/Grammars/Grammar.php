...
class Grammar extends BaseGrammar {
     ...
     * @return string
     */
    protected function whereBitwise($query, $where)
    {
     ...
     * @return string
     */
    protected function whereRowValues($query, $where)
    {
     ...
     * @return string
     */
    protected function whereJsonBoolean($query, $where)
    {
     ...
     * @return string
     */
    protected function whereJsonContains($query, $where)
    {
        $not = $where['not'] ? 'not ' : '';
     ...
     * @return string
     */
    protected function whereJsonLength($query, $where)
    {
     ...
     * @return string
     */
    public function whereFullText($query, $where)
    {
     ...
     * @return array
     */
    protected function compileOrdersToArray($query, $orders)
    {
     ...
     * @throws \RuntimeException
     */
    public function compileInsertOrIgnore($query, array $values)
    {
     ...
     * @return string
     */
    public function compileInsertUsing($query, array $columns, string $sql)
    {
     ...
     * @return string
     */
    public function compileUpdate($query, array $values)
    {
        $table = $this->wrapTable($query->from);
     ...
     * @return string
     */
    protected function compileUpdateColumns($query, array $values)
    {
     ...
     * @return string
     */
    protected function compileUpdateWithoutJoins($query, $table, $columns, $where)
    {
     ...
     * @return string
     */
    protected function compileUpdateWithJoins($query, $table, $columns, $where)
    {
     ...
     * @throws \RuntimeException
     */
    public function compileUpsert($query, array $values, array $uniqueBy, array $update)
    {
