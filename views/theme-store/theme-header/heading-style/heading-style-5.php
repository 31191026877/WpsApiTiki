...
Class ThemeHeadingStyle5 {
    ...
    static public function html($name, $options) {
        ...
        <div class="header-title header-title-style-5">
            ...
            <?php if(!empty($options['desContent'])) { ?><p class="header-description header-description-center"><?php echo $options['desContent'];?></p><?php } ?>
        </div>
        <?php
    }
