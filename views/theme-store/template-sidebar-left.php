		...
		<div id="td-outer-wrap">
			<div class="wrapper wrapper-<?php echo $this->template->class;?>">
				...
				<div class="container wrapper-container">
					<div class="row">
						<div class="order-md-2 order-1 col-12 col-lg-9"><?php $this->template->render_view(); ?></div>
						<div class="order-md-1 order-2 col-12 col-lg-3 sidebar"><?php Template::partial('include/sidebar');?></div>
					</div>
				</div>
