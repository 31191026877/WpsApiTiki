    ...
    <div class="ui-layout">
        ...
        <div class="col-md-12">
            <div class="ui-title-bar__group" style="padding-bottom:5px;">
                <h3 class="ui-title-bar__title"><?php echo $tabs[$current_tab]['label'];?></h3>
                <div class="ui-title-bar__action">
                    <?php foreach ($tabs as $key => $tab): ?>
                        <a href="<?php echo Url::admin(sicommerce::url('report'));?>&tab=<?php echo $key;?>" class="<?php echo ($key == $current_tab)?'active':'';?> btn btn-default">
        ...
        <div class="col-md-12">
            <div role="tabpanel">
                ...
                <div class="tab-content" style="padding-top: 10px;">
                    <?php call_user_func( $tabs[$current_tab]['callback'], $current_tab ) ?>
                </div>
            </div>
        </div>
